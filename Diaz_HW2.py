...
def writecsv(inputfile, header):
    ...
    for record in vcf_reader:
        ...
        if len(tumorAD) == 3:
            ...
            """
            if (x/sum >= 0.05 and y/sum >= 0.05) or (y/sum >= 0.05 and z/sum >= 0.05) or (x/sum >= 0.05 and z/sum >= 0.05):
                continue
            else:
                pass 
...
os.chdir("/home/rdiaz28/HW2/HW2_VCF_Files")
files = os.listdir()
